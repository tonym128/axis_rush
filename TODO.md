...
- when reloading the page I get
    - "The stylesheet http://localhost:5173/style.css was not loaded because its MIME type,
    “text/javascript”, is not “text/css”. localhost:5173"
    but if I hard refresh I don't get it
* make the main screen music very background, soft and peacefull, not invasive
- add sound effects for shooting, engine, being hit, boosting, energy platforms
